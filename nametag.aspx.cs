    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["rater_seq"] != null)
        {
            ...
            try
            {
                ...
                String query = "select RATER_PRENAME + ' ' + RATER_FNAME + ' ' + RATER_LNAME AS RATER_NAME,RATER_CITIZENID AS RATER_PID,RATER_CODE,RATER_PLACE from trn_xm_rater where RATER_STATUS = 'N' and RATER_SEQ = @seq";
