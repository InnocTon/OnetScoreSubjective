...
public partial class rater31data : System.Web.UI.Page
{
    ...
    public class recieveValue31
    {
        ...
        public string paperComplete { get; set; }
    ...
    public static string recieve(string recieveValue)
    {
        ...
        decimal paperComplete = Convert.ToDecimal(query.paperComplete.ToString());

        //if (query.useScore1_1.ToString() != "") { decimal scoreUse11 = Convert.ToDecimal(query.useScore1_1.ToString()); }
        //if (query.useScore1_2.ToString() != "") { decimal scoreUse12 = Convert.ToDecimal(query.useScore1_2.ToString()); }
        //if (query.useScore1_3.ToString() != "") { decimal scoreUse21 = Convert.ToDecimal(query.useScore1_3.ToString()); }
        //if (query.useScore1_4.ToString() != "") { decimal scoreUse22 = Convert.ToDecimal(query.useScore1_4.ToString()); }
        //if (query.useScore1_5.ToString() != "") { decimal scoreUse31 = Convert.ToDecimal(query.useScore1_5.ToString()); }
        //if (query.useScore1_6.ToString() != "") { decimal scoreUse32 = Convert.ToDecimal(query.useScore1_6.ToString()); }
        //if (query.useScore1_7.ToString() != "") { decimal scoreUse33 = Convert.ToDecimal(query.useScore1_7.ToString()); }
        //if (query.useScore1_8.ToString() != "") { decimal scoreUse34 = Convert.ToDecimal(query.useScore1_8.ToString()); }
        //if (query.useScoreSum.ToString() != "") { decimal suseScoreSum = Convert.ToDecimal(query.useScoreSum.ToString()); }
        ...
        try
        {
            ...
            command.Parameters.AddWithValue("@isComplete", paperComplete);
            command.Parameters.AddWithValue("@createby", HttpContext.Current.Session["USER_ID"].ToString());
            command.Transaction = trans;
            int result = command.ExecuteNonQuery();
            if (result == 1)
        ...
        try
        {
            ...
            SqlCommand command = new SqlCommand("UPDATE TRN_XM_SCORE_COPY1 SET IS_COMPLETE = @isComplete,UPDATE_BY = @updateby,UPDATE_DATETIME = getdate() WHERE STD_CODE = @stdCode;", conn);
        ...
        try
        {
            ...
            SqlCommand command = new SqlCommand("UPDATE TRN_XM_SCORE_COPY2 SET IS_COMPLETE = @isComplete,UPDATE_BY = @updateby,UPDATE_DATETIME = getdate() WHERE STD_CODE = @stdCode;", conn);
            //command.Parameters.AddWithValue("@updateby", "iOui");
            command.Parameters.AddWithValue("@stdCode", studentCode);
            command.Parameters.AddWithValue("@isComplete", paperComplete);
            command.Parameters.AddWithValue("@updateby", HttpContext.Current.Session["USER_ID"].ToString());
